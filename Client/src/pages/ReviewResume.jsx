  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        <input onChange={(e)=>setInput(e.target.files[0])} value={Input} type='application/pdf' accept='image/*' className='w-full p-2 px-3 mt-2 outline-none text-sm 
        rounded-md border border-gray-300 text-gray-600'  required/>

        
        <p className='text-xs text-gray-500 font-light mt-1'>PDF files only</p>
      ...
      border-gray-200 min-h-96 max-h-[600px]'>
        ...
        <div className='flex-1 flex justify-center items-center'>
          ...
          text-gray-400'>
            ...
            <p>Upload an resume "Review Resume" to get started</p>
